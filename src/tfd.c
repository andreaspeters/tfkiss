...
*                                                                          *
*                   DG0FT, DB2OS, 21.6.93                                  *
*                   Ucmd() ge�ndert, damit nur noch bei Upar == 2 die      *
...
*                                                                          *
*                   DB2OS,  27.08.94                                       *
*                   Bcmd(): Jetzt Anzeige f�r Anzahl der Hauptschleifen-   *
*                   durchg�nge in Rounds per Second.                       *
...
unsigned short ch;
{
  if (Epar == YES) {                 /* Echo eingeschaltet?               */
    if (!incnt && ch == defESC)      /* Kein Hostmode?                    */
      hputs("* ");                   /* Prompt f�r ESC-Zeichen ausgeben.  */
    else
      if (    ch >= ' '
           || ch == BELL
        ...
        hputc('.');                  /* Ersatz f�r Control-Zeichen        */
  }
}
...
/**************************************************************************\
*                                                                          *
* Bcmd:  RPS-Anzeige (Rounds per Seconds) fr�her DAMA-Timer.               *
*        Hauptschleifendurchg�nge pro Sekunde.                             *
*                                                                          *
\**************************************************************************/
void Bcmd()
  {
